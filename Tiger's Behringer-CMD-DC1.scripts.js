...
cmddc1.initDecksLEDs = function() {
    for(var i=cmddc1.FocusStartCtrl; i <= (cmddc1.DoubleStartCtrl+4); i++) {
        midi.sendShortMsg(cmddc1.defch | cmddc1.LEDCmd, i, 0x00);
    }
};
...
cmddc1.initCueMode = function() {
    midi.sendShortMsg(cmddc1.defch | cmddc1.LEDCmd, cmddc1.playCueCtrl, cmddc1.encLEDOff);
    midi.sendShortMsg(cmddc1.defch | cmddc1.LEDCmd, cmddc1.gotoCueCtrl, cmddc1.encLEDOff);
    midi.sendShortMsg(cmddc1.defch | cmddc1.LEDCmd, cmddc1.clearCueCtrl, cmddc1.encLEDOff);
    cmddc1.cueMode = undefined;
}
...
cmddc1.enableDeck = function(channel, control, value, status, group) {
    ...
    midi.sendShortMsg(cmddc1.defch | cmddc1.LEDCmd,
                      control,
                      (cmddc1.deckStatus[deck] == true ? cmddc1.LEDBlueBlink : cmddc1.encLEDOff)
         );
};
...
cmddc1.initLEDs = function() {
    ...
    for(var i=0x00; i <= 0x33; i++)
        midi.sendShortMsg(cmddc1.defch | cmddc1.LEDCmd, i, cmddc1.encLEDOff);
